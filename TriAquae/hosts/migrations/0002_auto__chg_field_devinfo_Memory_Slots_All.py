...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Devinfo.Memory_Slots_All'
        db.alter_column(u'hosts_devinfo', 'Memory_Slots_All', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Devinfo.Memory_Slots_All'
        db.alter_column(u'hosts_devinfo', 'Memory_Slots_All', self.gf('django.db.models.fields.CharField')(max_length=1000))
