...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Devinfo.Ethernet_Interface'
        db.alter_column(u'hosts_devinfo', 'Ethernet_Interface', self.gf('django.db.models.fields.CharField')(max_length=364))

    def backwards(self, orm):

        # Changing field 'Devinfo.Ethernet_Interface'
        db.alter_column(u'hosts_devinfo', 'Ethernet_Interface', self.gf('django.db.models.fields.CharField')(max_length=64))
