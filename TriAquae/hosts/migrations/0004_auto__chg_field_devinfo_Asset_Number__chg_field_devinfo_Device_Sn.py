...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Devinfo.Asset_Number'
        db.alter_column(u'hosts_devinfo', 'Asset_Number', self.gf('django.db.models.fields.CharField')(max_length=164))

        # Changing field 'Devinfo.Device_Sn'
        db.alter_column(u'hosts_devinfo', 'Device_Sn', self.gf('django.db.models.fields.CharField')(max_length=164))

    def backwards(self, orm):

        # Changing field 'Devinfo.Asset_Number'
        db.alter_column(u'hosts_devinfo', 'Asset_Number', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Devinfo.Device_Sn'
        db.alter_column(u'hosts_devinfo', 'Device_Sn', self.gf('django.db.models.fields.CharField')(max_length=64))
