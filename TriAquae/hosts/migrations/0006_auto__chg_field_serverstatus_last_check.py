...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServerStatus.last_check'
        db.alter_column(u'hosts_serverstatus', 'last_check', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ServerStatus.last_check'
        db.alter_column(u'hosts_serverstatus', 'last_check', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
