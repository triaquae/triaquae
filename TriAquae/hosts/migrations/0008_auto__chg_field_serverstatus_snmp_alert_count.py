...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServerStatus.snmp_alert_count'
        db.alter_column(u'hosts_serverstatus', 'snmp_alert_count', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'ServerStatus.snmp_alert_count'
        db.alter_column(u'hosts_serverstatus', 'snmp_alert_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
